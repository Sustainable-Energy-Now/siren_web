...
from powermatch.ui.colours import Colours
import powermatch.ui.displaytable as displaytable
import powermatch.ui.displayobject as displayobject
import powermap.ui.newstation as newstation
...
class MainWindow(QtWidgets.QMainWindow):
    ...
    #    self.view.customContextMenuRequested.connect(self.popup)
        ...
        quitModel = QtWidgets.QAction(QtGui.QIcon('resources/quit.png'), 'Quit', self)
        quitModel.setShortcut('Ctrl+Q')
        quitModel.setStatusTip('Quit Scenario')
        quitModel.triggered.connect(self.close)
        self.addExist = QtWidgets.QAction(QtGui.QIcon('resources/plus.png'), 'Add Existing', self)
        ...
        for scen_filter, chng, desc in self.view.scene()._scenarios:
            subFile = QtWidgets.QAction(QtGui.QIcon('resources/minus.png'), scen_filter, self)
            ...
            if scen_filter != 'Existing':
                subFile2 = QtWidgets.QAction(QtGui.QIcon('resources/edit.png'), scen_filter, self)
        ...
        getPower = QtWidgets.QAction(QtGui.QIcon('resources/power.png'), 'Power for ' + self.base_year, self)
        ...
        listStations = QtWidgets.QAction(QtGui.QIcon('resources/power-plant-icon.png'), 'List Stations', self)
        ...
        if self.old_grid:
            ...
            tip = 'List New Grid'
        listGrid = QtWidgets.QAction(QtGui.QIcon('resources/network.png'), tip, self)
        listGrid.setStatusTip(tip)
        listGrid.setShortcut('Ctrl+W')
        listGrid.triggered.connect(self.list_Grid)
        saveGrid = QtWidgets.QAction(QtGui.QIcon('resources/save_as.png'), 'Save Grid (as KML)', self)
        saveGrid.setStatusTip('Save Grid')
        saveGrid.triggered.connect(self.save_Grid)
        saveStations = QtWidgets.QAction(QtGui.QIcon('resources/save_as.png'), 'Save Stations (as KML)', self)
        ...
        if self.years is not None:
            ...
            for year in self.years:
                subPower = QtWidgets.QAction(QtGui.QIcon('resources/power.png'), year, self)
        ...
        getLoad = QtWidgets.QAction(QtGui.QIcon('resources/power.png'), 'Load for ' + self.base_year, self)
        ...
        if self.years is not None:
            ...
            for year in self.years:
                subLoad = QtWidgets.QAction(QtGui.QIcon('resources/power.png'), year, self)
                subLoad.triggered.connect(self.get_Load)
                subLoadMenu.addAction(subLoad)
        samver = QtWidgets.QAction(QtGui.QIcon('resources/question.png'), 'SAM Version', self)
        samver.setStatusTip('Query SAM Version')
        samver.triggered.connect(self.get_SAMVer)
        powerMenu.addAction(samver)
        self.escape = QtWidgets.QAction(QtGui.QIcon('resources/cancel.png'), 'Exit Visualise', self)
        ...
        if self.view.scene().show_capacity:
            self.showCapacity = QtWidgets.QAction(QtGui.QIcon('resources/check-mark.png'), 'Show Capacity Circles', self)
        else:
            self.showCapacity = QtWidgets.QAction(QtGui.QIcon('resources/blank.png'), 'Show Capacity Circles', self)
        ...
        if self.view.scene().show_generation:
            self.showGeneration = QtWidgets.QAction(QtGui.QIcon('resources/check-mark.png'), 'Show Generation Circles', self)
        else:
            self.showGeneration = QtWidgets.QAction(QtGui.QIcon('resources/blank.png'), 'Show Generation Circles', self)
        ...
        if self.view.scene().show_station_name:
            self.showName = QtWidgets.QAction(QtGui.QIcon('resources/check-mark.png'), 'Show Station Names', self)
        else:
            self.showName = QtWidgets.QAction(QtGui.QIcon('resources/blank.png'), 'Show Station Names', self)
        self.showName.setShortcut('Ctrl+N')
        self.showName.triggered.connect(self.show_Name)
        if self.view.scene().show_fossil:
            self.showFossil = QtWidgets.QAction(QtGui.QIcon('resources/check-mark.png'), 'Show Fossil-fueled Stations', self)
        else:
            self.showFossil = QtWidgets.QAction(QtGui.QIcon('resources/blank.png'), 'Show Fossil-fueled Stations', self)
        ...
        if self.view.scene().show_ruler:
            self.showRuler = QtWidgets.QAction(QtGui.QIcon('resources/check-mark.png'), 'Show Scale Ruler', self)
        else:
            self.showRuler = QtWidgets.QAction(QtGui.QIcon('resources/blank.png'), 'Show Scale Ruler', self)
        ...
        if self.view.scene().show_legend:
            self.showLegend = QtWidgets.QAction(QtGui.QIcon('resources/check-mark.png'), 'Show Legend', self)
        else:
            self.showLegend = QtWidgets.QAction(QtGui.QIcon('resources/blank.png'), 'Show Legend', self)
        self.showLegend.setStatusTip('Show Legend')
        self.showLegend.triggered.connect(self.show_Legend)
        if self.view.scene().show_towns:
            self.showTowns = QtWidgets.QAction(QtGui.QIcon('resources/check-mark.png'), 'Show Towns', self)
        else:
            self.showTowns = QtWidgets.QAction(QtGui.QIcon('resources/blank.png'), 'Show Towns', self)
        self.showTowns.setStatusTip('Show Towns')
        self.showTowns.triggered.connect(self.show_Towns)
        if self.view.scene().existing_grid:
            self.showOldg = QtWidgets.QAction(QtGui.QIcon('resources/check-mark.png'), 'Show Existing Grid', self)
        else:
            self.showOldg = QtWidgets.QAction(QtGui.QIcon('resources/blank.png'), 'Show Existing Grid', self)
        ...
        if self.view.scene().existing_grid2:
            self.showOldg2 = QtWidgets.QAction(QtGui.QIcon('resources/check-mark.png'), 'Show Existing Grid2', self)
        ...
        if self.view.scene().grid_zones:
            self.showZones = QtWidgets.QAction(QtGui.QIcon('resources/check-mark.png'), 'Show Grid Zones', self)
            self.showZones.setStatusTip('Show Grid Zones')
            self.showZones.triggered.connect(self.show_Zones)
        self.showLines = QtWidgets.QAction(QtGui.QIcon('resources/check-mark.png'), 'Show Station Connections', self)
        self.showLines.setStatusTip('Show Station Connections')
        self.showLines.triggered.connect(self.show_Lines)
        self.hideTrace = QtWidgets.QAction(QtGui.QIcon('resources/blank.png'), 'Clear Grid Trace', self)
        self.hideTrace.setStatusTip('Clear Grid Trace')
        self.hideTrace.triggered.connect(self.clear_Trace)
        self.showGrid = QtWidgets.QAction(QtGui.QIcon('resources/network.png'), 'Show Grid Line', self)
        self.showGrid.setStatusTip('Show Grid')
        self.showGrid.setShortcut('Ctrl+J')
        self.showGrid.triggered.connect(self.show_Grid)
        self.refreshGrid = QtWidgets.QAction(QtGui.QIcon('resources/refresh.png'), 'Refresh Grid', self)
        self.refreshGrid.setStatusTip('Refresh Grid')
        self.refreshGrid.triggered.connect(self.refresh_Grid)
        self.coordGrid = QtWidgets.QAction(QtGui.QIcon('resources/network.png'), 'Show Coordinates Grid', self)
        ...
        if self.view.scene().grid_areas:
            self.showAreas = QtWidgets.QAction(QtGui.QIcon('resources/check-mark.png'), 'Show Grid Areas', self)
            self.showAreas.setStatusTip('Show Grid Areas')
            self.showAreas.triggered.connect(self.show_Areas)
        self.goTo = QtWidgets.QAction(QtGui.QIcon('resources/arrow.png'), 'Go to Station', self)
        self.goTo.setShortcut('Ctrl+G')
        self.goTo.setStatusTip('Locate specific Station')
        self.goTo.triggered.connect(self.go_To)
        self.goToTown = QtWidgets.QAction(QtGui.QIcon('resources/arrowt.png'), 'Go to Town', self)
        self.goToTown.setShortcut('Ctrl+T')
        self.goToTown.triggered.connect(self.go_ToTown)
        self.goToLocn = QtWidgets.QAction(QtGui.QIcon('resources/arrow.png'), 'Go to Location', self)
        self.goToLocn.setShortcut('Ctrl+D')
        self.goToLocn.triggered.connect(self.go_ToLocn)
        self.saveView = QtWidgets.QAction(QtGui.QIcon('resources/camera.png'), 'Save View', self)
        ...
        if self.view.scene().load_centre is not None:
            self.goToLoad = QtWidgets.QAction(QtGui.QIcon('resources/arrow.png'), 'Go to Load Centre', self)
        ...
        self.editIni = QtWidgets.QAction(QtGui.QIcon('resources/edit.png'), 'Edit Preferences File', self)
        self.editIni.setShortcut('Ctrl+E')
        self.editIni.setStatusTip('Edit Preferences')
        self.editIni.triggered.connect(self.editIniFile)
        self.editColour = QtWidgets.QAction(QtGui.QIcon('resources/rainbow-icon.png'), 'Edit Colours', self)
        ...
        self.editFSect = QtWidgets.QAction(QtGui.QIcon('resources/arrow.png'), 'Edit File Sections', self)
        self.editFSect.setStatusTip('Edit File Preferences Sections')
        self.editFSect.triggered.connect(self.editFSects)
        self.editSect = QtWidgets.QAction(QtGui.QIcon('resources/arrow.png'), 'Edit Section', self)
        self.editSect.setStatusTip('Edit Preferences Section')
        self.editSect.triggered.connect(self.editSects)
        self.editTech = QtWidgets.QAction(QtGui.QIcon('resources/blank.png'), 'Edit Technologies', self)
        self.editTech.setStatusTip('Edit Technologies')
        self.editTech.triggered.connect(self.editTechs)
        self.showDtable = QtWidgets.QAction(QtGui.QIcon('resources/network.png'), 'Dispatchable Lines Table', self)
        self.showDtable.triggered.connect(self.showStables)
        self.showStable = QtWidgets.QAction(QtGui.QIcon('resources/network.png'), 'Standard Lines Table', self)
        self.showStable.triggered.connect(self.showStables)
        self.showLtable = QtWidgets.QAction(QtGui.QIcon('resources/blank.png'), 'Line Costs', self)
        self.showLtable.triggered.connect(self.showStables)
        self.showSStable = QtWidgets.QAction(QtGui.QIcon('resources/blank.png'), 'Substation Costs', self)
        ...
        self.showResource = QtWidgets.QAction(QtGui.QIcon('resources/grid.png'), 'Show Resource Grid', self)
        ...
        self.showFloatMenu = QtWidgets.QAction(QtGui.QIcon('resources/list.png'), 'Show Floating Menu', self)
        self.showFloatMenu.setStatusTip('Floating Menu')
        self.showFloatMenu.triggered.connect(self.show_FloatMenu)
        self.showFloatLegend = QtWidgets.QAction(QtGui.QIcon('resources/list.png'), 'Show Floating Legend', self)
        self.showFloatLegend.setStatusTip('Floating Menu')
        self.showFloatLegend.triggered.connect(self.show_FloatLegend)
        self.showFloatStatus = QtWidgets.QAction(QtGui.QIcon('resources/log.png'), 'Show Status Window', self)
        self.showFloatStatus.setStatusTip('Status Window')
        self.showFloatStatus.triggered.connect(self.show_FloatStatus)
        self.showData = QtWidgets.QAction(QtGui.QIcon('resources/grid.png'), 'Show Data View', self)
        self.showData.setStatusTip('Data View')
        self.showData.triggered.connect(self.show_Data)
        credit = QtWidgets.QAction(QtGui.QIcon('resources/about.png'), 'Credits', self)
        ...
        if self.years is not None:
            ...
            for year in self.years:
                subResource = QtWidgets.QAction(QtGui.QIcon('resources/grid.png'), year, self)
                subResource.triggered.connect(self.show_Resource)
                subWindowMenu.addAction(subResource)
        self.escaper = QtWidgets.QAction(QtGui.QIcon('resources/cancel.png'), 'Exit Resource Loop', self)
        ...
        utilicon = ['resources/download.png', 'resources/map.png', 'resources/download.png', 'resources/list.png', 'resources/grid.png', 'resources/weather.png',
                    'resources/power.png', 'resources/line.png', 'resources/list.png', 'gear_run.png']
        spawns = []
        icons = []
        ...
        help = QtWidgets.QAction(QtGui.QIcon('resources/help.png'), 'Help', self)
        help.setShortcut('F1')
        help.setStatusTip('Help')
        help.triggered.connect(self.showHelp)
        about = QtWidgets.QAction(QtGui.QIcon('resources/about.png'), 'About', self)
    ...
    def saveAsScenario(self):
        ...
        if fname != '':
            ...
            self.subMenu.clear()
            subFile = QtWidgets.QAction(QtGui.QIcon('resources/minus.png'), save_as, self)
            subFile.setStatusTip('Remove Scenario ' + save_as)
            subFile.triggered.connect(self.removeScenario)
            self.subMenu.addAction(subFile)
            if exist:
                subFile = QtWidgets.QAction(QtGui.QIcon('resources/minus.png'), 'Existing', self)
                subFile.setStatusTip('Remove Scenario Existing')
                subFile.triggered.connect(self.removeScenario)
                self.subMenu.addAction(subFile)
            self.subMenu2.clear()
            subFile2 = QtWidgets.QAction(QtGui.QIcon('resources/edit.png'), save_as, self)
...
# highlight grid line
    ...
    def popup(self, pos):
        def check_scenario():
            ...
            for i in range(len(self.view.scene()._scenarios)):
                ...
                subFile = QtWidgets.QAction(QtGui.QIcon('resources/minus.png'), station.scenario, self)
                subFile.setStatusTip('Remove Scenario ' + station.scenario)
                subFile.triggered.connect(self.removeScenario)
                self.subMenu.addAction(subFile)
                subFile2 = QtWidgets.QAction(QtGui.QIcon('resources/edit.png'), station.scenario, self)
        ...
        if station is not None:  # a stations
            ...
            if station.technology[:6] != 'Fossil':
                run1Action = menu.addAction(QtGui.QIcon('resources/power.png'), act2)
                run1Action.setIconVisibleInMenu(True)
                if self.years is not None:
                    subPwrMenu = menu.addMenu(QtGui.QIcon('resources/power.png'), 'Model %s Power for year' % station.name)
                    for year in self.years:
                        subPwr.append(QtWidgets.QAction(QtGui.QIcon('resources/power.png'), year, self))
                        subPwrMenu.addAction(subPwr[-1])
                cpyAction = menu.addAction(QtGui.QIcon('resources/copy.png'), act8)
                cpyAction.setIconVisibleInMenu(True)
            ctrAction = menu.addAction(QtGui.QIcon('resources/zoom.png'), act3)
            ctrAction.setIconVisibleInMenu(True)
            stnAction = menu.addAction(QtGui.QIcon('resources/info_green.png'), act4)
            stnAction.setIconVisibleInMenu(True)
            if station.scenario != 'Existing':
                mveAction = menu.addAction(QtGui.QIcon('resources/move.png'), act5)
                mveAction.setIconVisibleInMenu(True)
                delAction = menu.addAction(QtGui.QIcon('resources/minus.png'), act6)
            ...
            if self.view.scene().trace_grid:
                trcAction = menu.addAction(QtGui.QIcon('resources/line.png'), act13)
                trcAction.setIconVisibleInMenu(True)
            else:
                trcAction = ''
        addsAction = menu.addAction(QtGui.QIcon('resources/plus.png'), act7)
        addsAction.setIconVisibleInMenu(True)
        linAction = menu.addAction(QtGui.QIcon('resources/line.png'), act15)
        ...
        sunAction = menu.addAction(QtGui.QIcon('resources/weather.png'), act14)
        sunAction.setIconVisibleInMenu(True)
        subWthr = []
        if self.years is not None:
            subWthrMenu = menu.addMenu(QtGui.QIcon('resources/weather.png'), 'Show weather here for year')
            for year in self.years:
                subWthr.append(QtWidgets.QAction(QtGui.QIcon('resources/weather.png'), year, self))
                subWthrMenu.addAction(subWthr[-1])
        notAction = menu.addAction(ttitl)
        if ttitl[:2] != 'No':
            twnAction = menu.addAction(QtGui.QIcon('resources/info.png'), act9)
            twnAction.setIconVisibleInMenu(True)
        rulAction = menu.addAction(QtGui.QIcon('resources/ruler.png'), act10)
        rulAction.setIconVisibleInMenu(True)
        legAction = menu.addAction(QtGui.QIcon('resources/list.png'), act11)
        ...
        if action == addsAction:
            ...
            self.showRuler.setIcon(QtGui.QIcon('resources/check-mark.png'))
            ...
            self.showLegend.setIcon(QtGui.QIcon('resources/check-mark.png'))
    ...
    def show_Areas(self):
        ...
        if self.view.scene().grid_areas:
            self.showAreas.setIcon(QtGui.QIcon('resources/blank.png'))
            self.view.scene().grid_areas = False
            self.view.scene()._gridGroupa.setVisible(False)
            comment += ' Off'
        else:
            self.showAreas.setIcon(QtGui.QIcon('resources/check-mark.png'))
    ...
    def show_Capacity(self):
        ...
        if self.view.scene().show_capacity:
            self.showCapacity.setIcon(QtGui.QIcon('resources/blank.png'))
            ...
            self.showCapacity.setIcon(QtGui.QIcon('resources/check-mark.png'))
    ...
    def show_Generation(self):
        ...
        if self.view.scene().show_generation:
            self.showGeneration.setIcon(QtGui.QIcon('resources/blank.png'))
            self.view.scene().show_generation = False
            self.view.scene()._generationGroup.setVisible(False)
            comment += ' Off'
        else:
            self.showGeneration.setIcon(QtGui.QIcon('resources/check-mark.png'))
    ...
    def show_Fossil(self):
        ...
        if self.view.scene().show_fossil:
            self.showFossil.setIcon(QtGui.QIcon('resources/blank.png'))
            ...
            self.showFossil.setIcon(QtGui.QIcon('resources/check-mark.png'))
    ...
    def show_Towns(self):
        ...
        if self.view.scene().show_towns:
            self.showTowns.setIcon(QtGui.QIcon('resources/blank.png'))
            self.view.scene().show_towns = False
            self.view.scene()._townGroup.setVisible(False)
            comment += ' Off'
        else:
            self.showTowns.setIcon(QtGui.QIcon('resources/check-mark.png'))
    ...
    def show_OldGrid(self):
        ...
        if self.view.scene().existing_grid:
            self.showOldg.setIcon(QtGui.QIcon('resources/blank.png'))
            self.view.scene().existing_grid = False
            self.view.scene()._gridGroup.setVisible(False)
            comment += ' Off'
        else:
            self.showOldg.setIcon(QtGui.QIcon('resources/check-mark.png'))
    ...
    def show_OldGrid2(self):
        ...
        if self.view.scene().existing_grid2:
            self.showOldg2.setIcon(QtGui.QIcon('resources/blank.png'))
            self.view.scene().existing_grid2 = False
            self.view.scene()._gridGroup2.setVisible(False)
            comment += ' Off'
        else:
            self.showOldg2.setIcon(QtGui.QIcon('resources/check-mark.png'))
    ...
    def show_Zones(self):
        ...
        if self.view.scene().grid_zones:
            self.showZones.setIcon(QtGui.QIcon('resources/blank.png'))
            self.view.scene().grid_zones = False
            self.view.scene()._gridGroupz.setVisible(False)
            comment += ' Off'
        else:
            self.showZones.setIcon(QtGui.QIcon('resources/check-mark.png'))
    ...
    def show_Lines(self):
        ...
        if self.view.scene().line_group:
            self.showLines.setIcon(QtGui.QIcon('resources/blank.png'))
            self.view.scene().line_group = False
            self.view.scene()._lineGroup.setVisible(False)
            comment += ' Off'
        else:
            self.showLines.setIcon(QtGui.QIcon('resources/check-mark.png'))
    ...
    def coord_Grid(self):
        ...
        if self.view.scene().show_coord:
            ...
            self.coordGrid.setIcon(QtGui.QIcon('resources/blank.png'))
            comment += 'Off'
        else:
            self.view.scene().show_coord = True
            self.view.scene()._coordGroup.setVisible(True)
            self.coordGrid.setIcon(QtGui.QIcon('resources/check-mark.png'))
            comment += 'On'
        self.view.statusmsg.emit(comment)
    ...
    def show_Ruler(self):
        ...
        if self.view.scene().show_ruler:
            self.view.hide_Ruler()
            self.showRuler.setIcon(QtGui.QIcon('resources/blank.png'))
    ...
    def show_Legend(self):
        ...
        if self.view.scene().show_legend:
            self.view.hide_Legend()
            self.showLegend.setIcon(QtGui.QIcon('resources/blank.png'))
    ...
    def show_Name(self):
        ...
        if self.view.scene().show_station_name:
            self.showName.setIcon(QtGui.QIcon('resources/blank.png'))
            ...
            self.showName.setIcon(QtGui.QIcon('resources/check-mark.png'))
