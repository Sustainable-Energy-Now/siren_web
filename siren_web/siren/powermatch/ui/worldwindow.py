...
from siren.ui.editini import EdtDialog, EditSect, SaveIni
...
class WorldWindow(QtWidgets.QMainWindow):
    ...
    def __init__(self, parent, scene, era5=False):
       ...
       #  self.setWindowFlags(QtCore.Qt.FramelessWindowHint)
        ...
        self.showRuler = QtWidgets.QAction(QtGui.QIcon('resources/blank.png'), 'Scale Ruler', self)
        ...
        self.showGrid = QtWidgets.QAction(QtGui.QIcon('resources/blank.png'), 'Coordinates Grid', self)
        ...
        self.showMGrid = QtWidgets.QAction(QtGui.QIcon('resources/blank.png'), self.era + ' Grid', self)
        ...
        self.showMany = QtWidgets.QAction(QtGui.QIcon('resources/blank.png'), 'Show many Areas', self)
    ...
    def popup(self, pos):
        ...
        menu = QtWidgets.QMenu()
        act1 = 'Center here'
        ctrAction = menu.addAction(QtGui.QIcon('resources/zoom.png'), act1)
        ctrAction.setIconVisibleInMenu(True)
        act2 = 'Position ruler here'
        rulAction = menu.addAction(QtGui.QIcon('resources/ruler.png'), act2)
    ...
    def show_Grid(self):
        ...
        if self.view.scene().show_grid:
            ...
            self.showGrid.setIcon(QtGui.QIcon('resources/blank.png'))
            comment += 'Off'
        else:
            ...
            self.showGrid.setIcon(QtGui.QIcon('resources/check-mark.png'))
            comment += 'On'
        self.view.statusmsg.emit(comment)
    ...
    def show_MGrid(self):
        ...
        if self.view.scene().show_mgrid:
            ...
            self.showMGrid.setIcon(QtGui.QIcon('resources/blank.png'))
            comment += 'Off'
        else:
           ...
           #     pen2.setStyle(QtCore.Qt.DotLine)
            ...
            self.showMGrid.setIcon(QtGui.QIcon('resources/check-mark.png'))
            comment += 'On'
        self.view.statusmsg.emit(comment)
