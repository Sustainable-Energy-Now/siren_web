...
from siren.ui.editini import EditSect, SaveIni
from modules.getmodels import getModelFile
from powerplot import MyQDialog, ChangeFontProp
from utilities.senutils import ClickableQLabel, getParents, getUser, ListWidget, ssCol, strSplit, techClean, WorkBook
from powermatch.ui.zoompan import ZoomPanX
  ...
  #      self.xvalues.textChanged.connect(self.somethingChanged)
    ...
    def get_file_config(self, choice=''):
        ...
        if not os.path.exists(ifile) and not os.path.exists(self.scenarios + ifile):
            ...
            msgbox.setWindowIcon(QtGui.QIcon('resources/resources/sen_icon32.ico'))
