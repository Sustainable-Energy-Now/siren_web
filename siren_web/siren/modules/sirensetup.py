...
from modules.getmodels import commonprefix
from siren.ui.editini import EdtDialog, SaveIni
from utilities.senutils import ClickableQLabel
...
class SetUp(QtWidgets.QWidget):
    ...
    def __init__(self, help='help.html'):
        ...
        msg = 'SIREN requires an area of storage that it can write to.\n' + \
              'Use this program to copy the SIREN model and Sample Scenario files\n' + \
              'to a writeable location, e.g. your OneDrive.\n\n' + \
        ...
        if os.path.exists(updir + 'siren_sample'):
            ...
            if os.path.exists(f'{up2more}\\ProgramData\\SIREN\\siren_sample'):
                samples = f'{up2more}\\ProgramData\\SIREN\\siren_sample'
                self.msi = 'msi'
